...
Namespace ViewModels
    Public Class ImageGallery3DetailViewModel
        Inherits Observable
        ...
        Public Property SelectedImage As Object
            ...
            Set
                ...
                ApplicationData.Current.LocalSettings.SaveString(ImageGallery3ViewModel.ImageGallery3SelectedImageId, DirectCast(SelectedImage, SampleImage).ID)
            End Set
        End Property
        ...
        Public Sub Initialize(sampleImage As SampleImage)
            ...
            Dim animation = ConnectedAnimationService.GetForCurrentView().GetAnimation(ImageGallery3ViewModel.ImageGallery3AnimationOpen)
            animation?.TryStart(_image)
        End Sub

        Public Sub SetAnimation()
            ConnectedAnimationService.GetForCurrentView()?.PrepareToAnimate(ImageGallery3ViewModel.ImageGallery3AnimationClose, _image)
        End Sub
    End Class
End Namespace
