...
Namespace Views
    Public NotInheritable Partial Class ImageGallery3DetailPage
        Inherits Page
        Public ReadOnly Property ViewModel As ImageGallery3DetailViewModel = New ImageGallery3DetailViewModel()
        Public Sub New()
            InitializeComponent()
