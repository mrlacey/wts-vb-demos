...
Namespace Views
    ...
    Partial Public NotInheritable Class UriScheme8ExamplePage
        Inherits Page
        Private ReadOnly Property ViewModel As UriScheme8ExampleViewModel
            Get
                Return TryCast(DataContext, UriScheme8ExampleViewModel)
            End Get
        End Property
