...
Namespace Views
    Public NotInheritable Partial Class MediaPlayer8Page
        Inherits Page
        Private ReadOnly Property ViewModel() As MediaPlayer8ViewModel
          Get
            Return TryCast(DataContext, MediaPlayer8ViewModel)
          End Get
        End Property
