...
Namespace Models
    Public Class ShareSource8Data

        Public Property Title As String

        Public Property Description As String

        Friend Property Items As List(Of ShareSource8Item)
        ...
        Public Sub New(ByVal title As String, ByVal Optional desciption As String = Nothing)
            ...
            Items = New List(Of ShareSource8Item)()
            Title = title
        ...
        Public Sub SetText(ByVal text As String)
            ...
            Items.Add(ShareSource8Item.FromText(text))
        End Sub
        ...
        Public Sub SetWebLink(ByVal webLink As Uri)
            ...
            Items.Add(ShareSource8Item.FromWebLink(webLink))
        End Sub
        ...
        Public Sub SetApplicationLink(ByVal applicationLink As Uri)
            ...
            Items.Add(ShareSource8Item.FromApplicationLink(applicationLink))
        End Sub
        ...
        Public Sub SetHtml(ByVal html As String)
            ...
            Items.Add(ShareSource8Item.FromHtml(html))
        End Sub
        ...
        Public Sub SetImage(ByVal image As StorageFile)
            ...
            Items.Add(ShareSource8Item.FromImage(image))
        End Sub
        ...
        Public Sub SetStorageItems(ByVal storageItems As IEnumerable(Of IStorageItem))
            ...
            Items.Add(ShareSource8Item.FromStorageItems(storageItems))
        End Sub
        ...
        Public Sub SetDeferredContent(ByVal deferredDataFormatId As String, ByVal getDeferredDataAsyncFunc As Func(Of Task(Of Object)))
            ...
            Items.Add(ShareSource8Item.FromDeferredContent(deferredDataFormatId, getDeferredDataAsyncFunc))
        End Sub
    End Class
End Namespace
