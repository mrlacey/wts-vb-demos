...
Namespace Views
    Public NotInheritable Partial Class MasterDetail2Page
        Inherits Page
        ...
        Public Sub New()
            InitializeComponent()
            AddHandler Loaded, AddressOf MasterDetail2Page_Loaded
        End Sub

        Private Async Sub MasterDetail2Page_Loaded(sender As Object, e As RoutedEventArgs)
            SampleItems.Clear()
