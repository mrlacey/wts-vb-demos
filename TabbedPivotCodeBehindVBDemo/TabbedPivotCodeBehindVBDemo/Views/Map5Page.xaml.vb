...
Namespace Views
    Public NotInheritable Partial Class Map5Page
        Inherits Page
        ...
        Public Sub New()
            AddHandler Loaded, AddressOf Map5Page_Loaded
            AddHandler Unloaded, AddressOf Map5Page_Unloaded
        ...
        Private Async Sub Map5Page_Loaded(sender As Object, e As RoutedEventArgs)
            Await InitializeAsync()
        End Sub

        Private Sub Map5Page_Unloaded(sender As Object, e As RoutedEventArgs)
            Cleanup()
        End Sub
