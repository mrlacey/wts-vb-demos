...
Namespace Views
    Public NotInheritable Partial Class ImageGallery5DetailPage
        Inherits Page
        ...
        Public Property SelectedImage As Object
            ...
            Set
                ...
                ApplicationData.Current.LocalSettings.SaveString(ImageGallery5Page.ImageGallery5SelectedImageId, DirectCast(SelectedImage, SampleImage).ID)
            End Set
        End Property
        ...
        Protected Overrides Sub OnNavigatedTo(e As NavigationEventArgs)
            ...
            Dim animation = ConnectedAnimationService.GetForCurrentView().GetAnimation(ImageGallery5Page.ImageGallery5AnimationOpen)
        ...
        Protected Overrides Sub OnNavigatingFrom(e As NavigatingCancelEventArgs)
            ...
            If e.NavigationMode = NavigationMode.Back Then
                ...
                ConnectedAnimationService.GetForCurrentView()?.PrepareToAnimate(ImageGallery5Page.ImageGallery5AnimationClose, previewImage)
            End If
        End Sub
