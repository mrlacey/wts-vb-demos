...
Namespace Views
    Public NotInheritable Partial Class MasterDetail5Page
        Inherits Page
        ...
        Public Sub New()
            InitializeComponent()
            AddHandler Loaded, AddressOf MasterDetail5Page_Loaded
        End Sub

        Private Async Sub MasterDetail5Page_Loaded(sender As Object, e As RoutedEventArgs)
            SampleItems.Clear()
