...
Namespace Views
    Public NotInheritable Partial Class Settings5Page
        Inherits Page
        ...
        Public Sub New()
            AddHandler Loaded, AddressOf Settings5Page_Loaded
            InitializeComponent()
        End Sub

        Private Sub Settings5Page_Loaded(sender As Object, e As RoutedEventArgs)
            Initialize()
        End Sub
