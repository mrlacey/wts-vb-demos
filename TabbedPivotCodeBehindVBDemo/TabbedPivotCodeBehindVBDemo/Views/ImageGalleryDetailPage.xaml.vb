    ...
    Public NotInheritable Partial Class ImageGalleryDetailPage
        ...
        Public Property SelectedImage As Object
            ...
            Set
                ...
                ApplicationData.Current.LocalSettings.SaveString(ImageGalleryPage.ImageGallerySelectedIdKey, DirectCast(SelectedImage, SampleImage).ID)
            End Set
        End Property
        ...
        Protected Overrides Sub OnNavigatedTo(e As NavigationEventArgs)
            ...
            Dim animation = ConnectedAnimationService.GetForCurrentView().GetAnimation(ImageGalleryPage.ImageGalleryAnimationOpen)
