...
Namespace Models
    Public Class ShareSource7Data

        Public Property Title As String

        Public Property Description As String

        Friend Property Items As List(Of ShareSource7Item)
        ...
        Public Sub New(ByVal title As String, ByVal Optional desciption As String = Nothing)
            ...
            Items = New List(Of ShareSource7Item)()
            Title = title
        ...
        Public Sub SetText(ByVal text As String)
            ...
            Items.Add(ShareSource7Item.FromText(text))
        End Sub
        ...
        Public Sub SetWebLink(ByVal webLink As Uri)
            ...
            Items.Add(ShareSource7Item.FromWebLink(webLink))
        End Sub
        ...
        Public Sub SetApplicationLink(ByVal applicationLink As Uri)
            ...
            Items.Add(ShareSource7Item.FromApplicationLink(applicationLink))
        End Sub
        ...
        Public Sub SetHtml(ByVal html As String)
            ...
            Items.Add(ShareSource7Item.FromHtml(html))
        End Sub
        ...
        Public Sub SetImage(ByVal image As StorageFile)
            ...
            Items.Add(ShareSource7Item.FromImage(image))
        End Sub
        ...
        Public Sub SetStorageItems(ByVal storageItems As IEnumerable(Of IStorageItem))
            ...
            Items.Add(ShareSource7Item.FromStorageItems(storageItems))
        End Sub
        ...
        Public Sub SetDeferredContent(ByVal deferredDataFormatId As String, ByVal getDeferredDataAsyncFunc As Func(Of Task(Of Object)))
            ...
            Items.Add(ShareSource7Item.FromDeferredContent(deferredDataFormatId, getDeferredDataAsyncFunc))
        End Sub
    End Class
End Namespace
