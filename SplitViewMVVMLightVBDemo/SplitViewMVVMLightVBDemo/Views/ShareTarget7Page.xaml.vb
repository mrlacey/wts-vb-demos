...
Namespace Views
    ...
    Public NotInheritable Partial Class ShareTarget7Page
        Inherits Page

        Private ReadOnly Property ViewModel As ShareTarget7ViewModel
            Get
                Return TryCast(DataContext, ShareTarget7ViewModel)
            End Get
        End Property
