...
Namespace Views
    Public NotInheritable Partial Class MediaPlayer7Page
        Inherits Page
        Private ReadOnly Property ViewModel() As MediaPlayer7ViewModel
          Get
            Return TryCast(DataContext, MediaPlayer7ViewModel)
          End Get
        End Property
