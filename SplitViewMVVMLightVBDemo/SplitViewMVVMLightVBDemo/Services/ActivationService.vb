Imports SplitViewMVVMLightVBDemo.Activation
...
Namespace Services
    ...
    Friend Class ActivationService
        ...
        Private Async Function InitializeAsync() As Task
            Await Singleton(Of StoreNotifications7Service).Instance.InitializeAsync()
            Await Singleton(Of LiveTile7Service).Instance.EnableQueueAsync()
        ...
        Private Async Function StartupAsync() As Task
            ...
            Singleton(Of LiveTile7Service).Instance.SampleUpdate()

            ' TODO WTS: To use the HubNotificationService specific data related with your Azure Notification Hubs is required.
            '  1. Go to the HubNotifications7Service class, in the InitializeAsync() method, provide the Hub Name and DefaultListenSharedAccessSignature.
            '  2. Uncomment the following line (an exception will be thrown if it is executed and the above information is not provided).
            ' Await Singleton(Of HubNotifications7Service).Instance.InitializeAsync()
        ...
        Private Iterator Function GetActivationHandlers() As IEnumerable(Of ActivationHandler)
            ...
            yield Singleton(Of ToastNotifications7Service).Instance
            Yield Singleton(Of SuspendAndResumeService).Instance
            yield Singleton(Of StoreNotifications7Service).Instance
            yield Singleton(Of ShareTarget7ActivationHandler).Instance
            yield Singleton(Of LiveTile7Service).Instance
            yield Singleton(Of HubNotifications7Service).Instance
