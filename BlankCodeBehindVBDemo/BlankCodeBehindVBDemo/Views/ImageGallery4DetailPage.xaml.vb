...
Namespace Views
    Public NotInheritable Partial Class ImageGallery4DetailPage
        Inherits Page
        ...
        Public Property SelectedImage As Object
            ...
            Set
                ...
                ApplicationData.Current.LocalSettings.SaveString(ImageGallery4Page.ImageGallery4SelectedImageId, DirectCast(SelectedImage, SampleImage).ID)
            End Set
        End Property
        ...
        Protected Overrides Sub OnNavigatedTo(e As NavigationEventArgs)
            ...
            Dim animation = ConnectedAnimationService.GetForCurrentView().GetAnimation(ImageGallery4Page.ImageGallery4AnimationOpen)
        ...
        Protected Overrides Sub OnNavigatingFrom(e As NavigatingCancelEventArgs)
            ...
            If e.NavigationMode = NavigationMode.Back Then
                ...
                ConnectedAnimationService.GetForCurrentView()?.PrepareToAnimate(ImageGallery4Page.ImageGallery4AnimationClose, previewImage)
            End If
        End Sub
