...
Namespace Models
    Public Class ShareSource4Data

        Public Property Title As String

        Public Property Description As String

        Friend Property Items As List(Of ShareSource4Item)
        ...
        Public Sub New(ByVal title As String, ByVal Optional desciption As String = Nothing)
            ...
            Items = New List(Of ShareSource4Item)()
            Title = title
        ...
        Public Sub SetText(ByVal text As String)
            ...
            Items.Add(ShareSource4Item.FromText(text))
        End Sub
        ...
        Public Sub SetWebLink(ByVal webLink As Uri)
            ...
            Items.Add(ShareSource4Item.FromWebLink(webLink))
        End Sub
        ...
        Public Sub SetApplicationLink(ByVal applicationLink As Uri)
            ...
            Items.Add(ShareSource4Item.FromApplicationLink(applicationLink))
        End Sub
        ...
        Public Sub SetHtml(ByVal html As String)
            ...
            Items.Add(ShareSource4Item.FromHtml(html))
        End Sub
        ...
        Public Sub SetImage(ByVal image As StorageFile)
            ...
            Items.Add(ShareSource4Item.FromImage(image))
        End Sub
        ...
        Public Sub SetStorageItems(ByVal storageItems As IEnumerable(Of IStorageItem))
            ...
            Items.Add(ShareSource4Item.FromStorageItems(storageItems))
        End Sub
        ...
        Public Sub SetDeferredContent(ByVal deferredDataFormatId As String, ByVal getDeferredDataAsyncFunc As Func(Of Task(Of Object)))
            ...
            Items.Add(ShareSource4Item.FromDeferredContent(deferredDataFormatId, getDeferredDataAsyncFunc))
        End Sub
    End Class
End Namespace
