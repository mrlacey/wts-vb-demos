...
Namespace Views
    Public NotInheritable Partial Class MediaPlayer1Page
        Inherits Page
        Private ReadOnly Property ViewModel() As MediaPlayer1ViewModel
          Get
            Return TryCast(DataContext, MediaPlayer1ViewModel)
          End Get
        End Property
