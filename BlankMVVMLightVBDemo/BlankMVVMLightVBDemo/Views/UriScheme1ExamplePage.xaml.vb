...
Namespace Views
    ...
    Partial Public NotInheritable Class UriScheme1ExamplePage
        Inherits Page
        Private ReadOnly Property ViewModel As UriScheme1ExampleViewModel
            Get
                Return TryCast(DataContext, UriScheme1ExampleViewModel)
            End Get
        End Property
