...
Namespace Views
    Public NotInheritable Partial Class ImageGallery1DetailPage
        Inherits Page
        Private ReadOnly Property ViewModel() As ImageGallery1DetailViewModel
            Get
                Return TryCast(DataContext, ImageGallery1DetailViewModel)
            End Get
        End Property
