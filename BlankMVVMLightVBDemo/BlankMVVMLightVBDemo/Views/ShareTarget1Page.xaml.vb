...
Namespace Views
    ...
    Public NotInheritable Partial Class ShareTarget1Page
        Inherits Page

        Private ReadOnly Property ViewModel As ShareTarget1ViewModel
            Get
                Return TryCast(DataContext, ShareTarget1ViewModel)
            End Get
        End Property
